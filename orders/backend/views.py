...
from .tasks import new_user_task, new_order_task, do_import
        ...
        if {'first_name', 'last_name', 'email', 'password', 'company', 'position'}.issubset(request.data):
            ...
            try:
                ...
                if user_serializer.is_valid():
                    ...
                    user.save()
                    new_user_task.delay(user_id=user.id)
...
class CategoryView(ListAPIView):
    ...
    """
    # Категории и магазины создаются при обновлении прайса поставщика
